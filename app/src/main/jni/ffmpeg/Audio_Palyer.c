...
JNIEXPORT void JNICALL Java_com_jcy_ndk_nativeC_ffmpeg_FFmpegPalyer_sound
        (JNIEnv *env, jobject jthis, jstring input_jstr, jstring output_jstr) {
    ...
    jobject audio_track = (*env)->CallObjectMethod(env,jthis,create_audio_track_mid,out_sample_rate,out_channel_nb);
